...
try {
  $stmt = $pdo->query("
        ...
        ORDER BY gender ASC, muscle_group ASC, name_fr ASC
    ");
...
// Séparer par gender
$videosMale = array_filter($allVideos, fn($v) => $v['gender'] === 'male' || $v['gender'] === 'both');
$videosFemale = array_filter($allVideos, fn($v) => $v['gender'] === 'female' || $v['gender'] === 'both');
